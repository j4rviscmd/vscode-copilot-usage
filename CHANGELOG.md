...
- Make configuration changes (displayMode, labelStyle, refreshInterval) take effect immediately without restarting VSCode

## [0.4.0] - 2026-03-16

### Added

- Add display mode toggle for usage (used/remaining)

### Fixed

- Use API percent_remaining for usage calculation
